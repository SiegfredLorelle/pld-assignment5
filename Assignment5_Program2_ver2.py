...
def AskInput():
    ...
    FirstNum = float(input("1st input:  "))
    SecNum = float(input("2nd input:  "))
    ThirdNum = float(input("3rd input:  "))
...
def Display(LowestNumF, InputNumF):
    if (LowestNumF - int(LowestNumF)) == 0:   #para lng d lumabas ung .0 kapag integer nmn ung inenter sa simula
